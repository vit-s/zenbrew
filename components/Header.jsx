    ...
    <header className={'absolute top-[40px] left-0 right-0 z-[60]'}>
      <div className="container mx-auto">
        <div className={'flex justify-between items-center'}>
          ...
          >
            {/*1*/}
            <span className={`w-full h-[1.5px] bg-current absolute left-0 will-change-transform transition-transform duration-300 ${navActive ? 'top-1/2 rotate-45' : 'top-8 translate-y-0'}`}></span>
            {/*2*/}
